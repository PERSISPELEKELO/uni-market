...
### Correct Namespaces (Filament v3)

- Form fields & layout (`TextInput`, `Select`, `Section`, `Grid`, `Fieldset`, `Tabs`, etc.): `Filament\Forms\Components\`
- Form utilities (`Get`, `Set`, etc.): `Filament\Forms\Get`, `Filament\Forms\Set`
- Table columns (`TextColumn`, `IconColumn`, etc.): `Filament\Tables\Columns\`
- Table actions: `Filament\Tables\Actions\`
- Page actions: `Filament\Actions\`
- Infolist entries (`TextEntry`, `IconEntry`, etc.): `Filament\Infolists\Components\`
- Icons: Heroicon strings (e.g., `'heroicon-o-scale'`, `'heroicon-m-check'`)
